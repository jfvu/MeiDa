...
public class ChatRecyclerAdapter  extends RecyclerView.Adapter{
    ...
    public ChatRecyclerAdapter(Context context,List<String> stringList){
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        ...
        return new ChatRecyclerAdapter.ViewHolder(view,mOnItemClickListener,mOnItemLongClickListener);
    }

    @Override
    public void onBindViewHolder(RecyclerView.ViewHolder holder, int position) {
        ChatRecyclerAdapter.ViewHolder viewHolder = (ChatRecyclerAdapter.ViewHolder) holder;
    ...
    private class ViewHolder extends MyViewHolder {
        ...
        public ViewHolder(View itemView, MyViewHolder.OnItemClickListener listener1, MyViewHolder.OnItemLongClickListener listener2) {
            ...
            textview = (TextView) itemView.findViewById(R.id.tv_showcount);
            imgTag = (ImageView) itemView.findViewById(R.id.img_header);
