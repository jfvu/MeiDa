...
public class PopWin2 extends PopupWindow {
    ...
    public PopWin2(Context mContext, View.OnClickListener itemsOnClick) {

        this.view = LayoutInflater.from(mContext).inflate(R.layout.popu_withdraw, null);

        btn_01 = (TextView) view.findViewById(R.id.qq);
        btn_02= (TextView) view.findViewById(R.id.weixin);
        btn_03= (TextView) view.findViewById(R.id.weibo);
